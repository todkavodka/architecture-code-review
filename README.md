...
- **Code Quality Review** — независимая оценка реализационных механизмов с существенными последствиями для сопровождаемости, надёжности, тестируемости, жизненного цикла, ресурсов, конкурентности, зависимостей и локализации; capability можно выбирать отдельно в Review Suite. [Entrypoint](capabilities/code-quality-review/SKILL.md);
