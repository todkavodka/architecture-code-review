# Authority и provenance

`architecture-code-review` намеренно не хранит весь смысл в одном Markdown-файле. Разные виды данных имеют разных владельцев, потому что они отвечают на разные вопросы и живут по разным lifecycle rules.

## Почему нужен authority map
